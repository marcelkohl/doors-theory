...
//          il_posicaoAcerto := 3; // fixa porta selecionada
          memCombinations.Lines.Add('Convidado selecionou porta:'+IntToStr(il_posicaoAcerto));
                 ...
                 begin
                      ...
                      if (al_portas[il_posicaoRevelada] = 0) and (il_posicaoRevelada <> il_posicaoAcerto) then
                       begin
                          ...
                          memCombinations.Lines.Add('Apresentador revelou a porta:'+IntToStr(il_revelado));
                       end;
                 end;
           end;
          ...
          if bg_TrocarQuandoChance = true then
           begin
                ...
                memCombinations.Lines.Add('Convidado trocou para a porta:'+IntToStr(il_posicaoAcerto));

           end
          else
           memCombinations.Lines.Add('Convidado ficou na porta:'+IntToStr(il_posicaoAcerto));
          ...
          if al_portas[il_posicaoAcerto] = 1 then
           begin
                ...
                memCombinations.Lines.Add('Convidado acertou ficando na porta:'+IntToStr(il_posicaoAcerto));
           end
          else
           memCombinations.Lines.Add('Convidado errou ficando na porta:'+IntToStr(il_posicaoAcerto));



          memCombinations.Lines.Add('Portas: ['+IntToStr(al_portas[1])+'-'+IntToStr(al_portas[2])+'-'+IntToStr(al_portas[3])+']');
     end;
    ...
    memDataLog.Lines.Add('Convidado acertou '+IntToStr(il_contaAcerto)+' vezes');
    memDataLog.Lines.Add('das quais: '+IntToStr(al_contaAcertos[1])+' na porta 1, '+IntToStr(al_contaAcertos[2])+' na porta 2, '+IntToStr(al_contaAcertos[3])+' na porta 3');
    memDataLog.Lines.Add(' ');
